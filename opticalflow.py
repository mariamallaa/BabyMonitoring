...
#cap = cv.VideoCapture("C:\\Users\\Maram\\Desktop\\GP2\\Dataset\\Breathing\\tummy backhead.mp4")
...
print(signals.shape)
#plt.plot(signals[:, 0, 0, 0], signals[:, 0, 0, 1])
print(signals[:, 20, 0, :])
plt.plot(signals[:, 2, 0, 0], signals[:, 2, 0, 1])
plt.show()
